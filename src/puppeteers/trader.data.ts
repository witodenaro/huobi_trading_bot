...
export const CONSERVATIVE_LONG_STOP_LOSS_DEVIATION = -CONSERVATIVE_STOP_LOSS_DEVIATION;
export const CONSERVATIVE_SHORT_STOP_LOSS_DEVIATION = +CONSERVATIVE_STOP_LOSS_DEVIATION;

export const INTERMEDIATE_LONG_STOP_LOSS_DEVIATION = -INTERMEDIATE_STOP_LOSS_DEVIATION;
export const INTERMEDIATE_SHORT_STOP_LOSS_DEVIATION = +INTERMEDIATE_STOP_LOSS_DEVIATION;
