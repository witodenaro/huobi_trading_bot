...
export const config = {
	...
	SPOT_SOCKET_SIGNATURE_VERSION: process.env.SPOT_SOCKET_SIGNATURE_VERSION as string,
	USDTM_SOCKET_SIGNATURE_VERSION: process.env.USDTM_SOCKET_SIGNATURE_VERSION as string,
};